...
const Dropdown: React.FC<any> = ({ title, options, onSelect }: DropdownProps) => {
  ...
  return (
    <div className="relative inline-block w-full">
      <button
        ...
        className="inline-flex items-center gap-2.5 text-body  w-full rounded border-[2px] border-stroke py-3 px-5.5 font-medium hover:bg-opacity-95 w-full justify-between"
      >
        {selectedOption == null ? title : selectedOption}
        <svg
